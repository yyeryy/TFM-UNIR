...
def main():
    ...
    RUTA_CHECKPOINT = RUTA_MODELOS / "resnet50_ppmi_best.pth"
    ...
    try:
        ...
        print("ResNet50 cargado con pesos preentrenados de ImageNet.")
    except Exception as e:
        print("No se pudieron cargar los pesos preentrenados.")
        print(f"Motivo: {e}")
        print("Se usará ResNet50 sin pesos preentrenados.")
